...
#ifdef FLIGHT_PRELOAD
buffer_data_t expt_preload =  {0x22, 0x69, 0x255,0x61,
0x74,0x00,0x00,0x1A,0x11,0xc5,0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
...
#ifdef FLIGHT_PRELOAD
artibeus_push_ascii_pkt(&expt_preload);
artibeus_push_telem_pkt();// No args, we'll just push junk
#endif
